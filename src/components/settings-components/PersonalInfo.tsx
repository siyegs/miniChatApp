      ...
      >
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-neutral-600 bg-neutral-50 text-neutral-900 text-base transition mb-3"
        ...
        <button
          ...
          className="w-fit box-border flex items-center justify-center gap-2 bg-gradient-to-r from-neutral-900 to-neutral-700 text-white py-2.5 rounded-lg font-semibold shadow-md hover:from-neutral-800 hover:to-neutral-600 transition disabled:opacity-60 disabled:cursor-not-allowed text-[13px]"
        >
          {isLoading ? (
